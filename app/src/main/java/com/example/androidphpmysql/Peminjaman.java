...
public class Peminjaman extends AppCompatActivity {
    ...
    private void fetchSiswa() {
        String url = "http://192.168.4.143/android/v1/get_siswa.php";
    ...
    private void fetchBarang() {
        String url = "http://192.168.4.143/android/v1/get_barang.php";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                response -> {
                    listBarang.clear();
                    try {
    ...
    private void fetchKelas() {
        String url = "http://192.168.4.143/android/v1/get_kelas.php";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                response -> {
                    listKelas.clear();
                    try {
    ...
    private void submitForm() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.4.143/android/v1/peminjaman.php",
                response -> {
                    try {
