    ...
    private void loadDashboardStats() {
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Constants.ADMIN_DASHBOARD_STATS, null,
                        ...
                        if (networkResponse != null && networkResponse.data != null) {
                            try {
                                ...
                                if (data.has("message")) {
                                    ...
                                    android.util.Log.e("OfficerDashboardActivity", "Laravel Error: " + errorMessage, error);
                                }
                            } catch (Exception e) {
                                android.util.Log.e("OfficerDashboardActivity", "Error parsing error response", e);
                            }
                        }
                        android.util.Log.e("OfficerDashboardActivity", "Volley error", error);
            ...
            public java.util.Map<String, String> getHeaders() {
                ...
                headers.put("Authorization", "Bearer " + SharedPrefManager.getInstance(OfficerDashboardActivity.this).getToken());
                return headers;
            }
        };
